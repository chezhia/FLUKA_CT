...
load('HA_tissue_range_constants.mat');

% Read Range File
HU_rangearray = csvread('HA_range_file_Table_foam.csv',0,0);
 
% Open Material and Body files
fid_mat = fopen('HA_FOAM_Mat_rev.txt','w');
fid_bod = fopen('HA_FOAM_Body_rev.txt','w');
