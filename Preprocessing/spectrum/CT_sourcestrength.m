...
Eff_Col = abs(heel_profile(length(heel_profile),1)-heel_profile(1,1))*10;
...
%if ((heel_profile(z,1) > -Eff_Col/2) & (heel_profile(z,1) < Eff_Col/2) )   
  ...
  Src_BOW =  Src_BOW + Bowtie_profile_full(i,2) * bin_area_BH * mAs  ; %* SDD_2/D2;
...
% save([col{1} '_Src_strength_80_Film.mat'],'Src_BOW_HEEL','Src_BOW');